...
public class TampilSemuaSiswa extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void showStudents(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                students.put(konfigurasi.TAG_ID,id);
                students.put(konfigurasi.TAG_NAMA,name);
                list.add(students);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String studentId = map.get(konfigurasi.TAG_ID);
        intent.putExtra(konfigurasi.STUDENT_ID,studentId);
